module.exports = function(grunt) {
  ...
  grunt.initConfig({
      ...
      fonts: {
        files: [
...

          {
              ...
              dest: 'qdrant_sphinx_theme/static/fonts/IBMPlexMono',
              filter: 'isFile'
          }
        ]
      },
        ...
        files: [
          {
              ...
              flatten: true,
              src: ['images/*'],
              dest: 'qdrant_sphinx_theme/static/images',
              filter: 'isFile'
          }
        ]
      },
    ...
    sass: {
      dev: {
        ...
        files: [{
          ...
          cwd: 'scss',
          src: ['*.scss'],
          dest: 'qdrant_sphinx_theme/static/css',
          ext: '.css'
        }]
      },
      build: {
    ...
    postcss: {
      ...
      dist: {
        files: {
          "qdrant_sphinx_theme/static/css/theme.css": "qdrant_sphinx_theme/static/css/theme.css"
        }
      }
    },
    ...
    browserify: {
      dev: {
        options: {
          external: ['jquery'],
          alias: {
            'qdrant_sphinx_theme': './js/theme.js'
          }
        },
        src: ['js/*.js'],
        dest: 'qdrant_sphinx_theme/static/js/theme.js'
      },
      build: {
        options: {
          external: ['jquery'],
    ...
    uglify: {
      dist: {
        ...
        files: [{
          expand: true,
          src: ['qdrant_sphinx_theme/static/js/*.js', '!qdrant_sphinx_theme/static/js/*.min.js'],
          dest: 'qdrant_sphinx_theme/static/js/',
    ...
    clean: {
      build: ["docs/build"],
      fonts: ["qdrant_sphinx_theme/static/fonts"],
      images: ["qdrant_sphinx_theme/static/images"],
      css: ["qdrant_sphinx_theme/static/css"],
      js: ["qdrant_sphinx_theme/static/js/*", "!qdrant_sphinx_theme/static/js/modernizr.min.js"]
    },
    ...
    watch: {
      ...
      sphinx: {
        files: ['qdrant_sphinx_theme/**/*', 'README.rst', 'docs/**/*.rst', 'docs/**/*.py'],
